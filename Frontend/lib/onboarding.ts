export const ONBOARDING_STEPS = [
  ...
  { stepNumber: 4,  title: "School Data Collected",     description: "Collect student roster, teacher list, and class schedule in standard CSV template.",   assignee: "EnrollOps Ops" },
  { stepNumber: 5,  title: "Admin Account Created",     description: "Create super-admin account on EnrollOps platform with school email domain configured.",  assignee: "Tech Team" },
  ...
  { stepNumber: 7,  title: "Platform Demo Completed",   description: "Run 90-minute live demo for teachers covering all core EnrollOps features.",             assignee: "Product Team" },
